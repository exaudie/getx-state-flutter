  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          'INTO THE METAVERSE',
          style: TextStyleApp.montserratFS20Bold.copyWith(color: Colors.white),
        ),
        Padding(
          ...
          child: Text(
            ...
            style: TextStyleApp.montserratFS16H26Regular.copyWith(color: Colors.white),
          ),
        ),
        SizedBox(
